...
const navItems: Array<{ href: string; label: string; icon: LucideIcon; roles: Role[] }> = [
  ...
  { href: "/statements", label: "Statements", icon: FileText, roles: ["Customer"] },
  { href: "/transfers", label: "Transfers", icon: Send, roles: ["BranchManager", "Teller", "Customer"] },
  ...
  { href: "/approvals", label: "Approvals", icon: ClipboardCheck, roles: ["BranchManager", "LoanOfficer"] },
  { href: "/teller", label: "Teller", icon: Users, roles: ["Teller", "BranchManager"] },
